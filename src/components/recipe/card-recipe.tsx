...
const RecipeCard: React.FC<RecipeCardProps> = ({
  ...
  return (
    <div
      className="w-full rounded-lg overflow-hidden border bg-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
      <div className="relative aspect-[4/3] w-full bg-gray-100">
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-4">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-bold text-white truncate">{recipe.title}</h3>
            {showDetailsButton && (
              <Popover>
